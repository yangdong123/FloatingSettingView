...
//
    ...
    public static class Builder{
        public float cx, cy, dx, dy, radius;
        public int color;
    ...
    public void circleClick(boolean flag, boolean showAnim){
        if (isAnim) {
            return;
        }
        isNowBigCircle = flag;
...
//        }
    ...
    private void animClick(){
        ...
        ValueAnimator animator = ValueAnimator.ofFloat(1, 0.8f, 1);
